---
source_artifact: docs/features/F010_Debugging/test-cases.md
claims_total: 1
...
# Confidence Report -- docs/features/F010_Debugging/test-cases.md
...
- Coverage Notes: marked `` with "exact line range not re-verified in this pass" — too uncertain a basis
