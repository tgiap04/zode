...
description: "Debugger Extensions for Zode extensions."
---
...
Zode offers an automatic way to create debug scenarios with _debug locators_.
...
See DAP servers published as extensions [on Zode's site](https://zed.dev/extensions?filter=debug-adapters).
