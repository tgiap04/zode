---
title: Deno
description: "Configure Deno language support in Zode, including language servers, formatting, and debugging."
---
...
See [Configuring supported languages](../configuring-languages.md) in the Zode documentation for more information.
