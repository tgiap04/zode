---
title: PHP
description: "Configure PHP language support in Zode, including language servers, formatting, and debugging."
---
...
The PHP extension uses [LSP language servers](https://microsoft.github.io/language-server-protocol) with Phpactor as the default. If you want to use other language servers that support Zode (e.g. Intelephense or PHP Tools), make sure to follow the documentation on how to implement it.
...
Check out the documentation of [PHP Tools for Zode](https://docs.devsense.com/other/zed/) for more details.
...
Zode supports syntax highlighting for PHPDoc comments.
...
- Ensure that the host and port matches between Xdebug and Zode.
