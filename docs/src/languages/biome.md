---
title: Biome
description: "Configure Biome language support in Zode, including language servers, formatting, and debugging."
---

# Biome

[Biome](https://biomejs.dev/) support in Zode is provided by the community-maintained [Biome extension](https://github.com/biomejs/biome-zed).
...
See the [Biome Zode Extension README](https://github.com/biomejs/biome-zed) for a complete list of features and configuration options.
