---
title: Kotlin
description: "Configure Kotlin language support in Zode, including language servers, formatting, and debugging."
---

# Kotlin

Kotlin language support in Zode is provided by the community-maintained [Kotlin extension](https://github.com/zed-extensions/kotlin).
