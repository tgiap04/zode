---
title: Swift
description: "Configure Swift language support in Zode, including language servers, formatting, and debugging."
---

# Swift

Swift language support in Zode is provided by the community-maintained [Swift extension](https://github.com/zed-extensions/swift).
...
Zode's name for the adapter (in the UI and `debug.json`) is `Swift`, and under the hood it uses [`lldb-dap`](https://github.com/swiftlang/llvm-project/blob/next/lldb/tools/lldb-dap/README.md), as provided by the Swift toolchain.
