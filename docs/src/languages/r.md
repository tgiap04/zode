---
title: R
description: "Configure R language support in Zode, including language servers, formatting, and debugging."
---

# R

R support is available via multiple R Zode extensions:
...
3. Install the [R](https://github.com/ocsmit/zed-r) extension through Zode's extensions manager for basic R language support (syntax highlighting, tree-sitter support) and for [REditorSupport/languageserver](https://github.com/REditorSupport/languageserver) support.

4. Install the [Air](https://posit-dev.github.io/air/) extension through Zode's extensions manager for R code formatting via Air.
...
[Air](https://posit-dev.github.io/air/) provides code formatting for R, including support for format-on-save. The [Air documentation for Zode](https://posit-dev.github.io/air/editor-zed.html) contains the most up-to-date advice for running Air in Zode.

Ensure that you have installed both the [ocsmit/zed-r](https://github.com/ocsmit/zed-r) extension (for general R language awareness in Zode) and the [Air](https://posit-dev.github.io/air/) extension.
...
You can configure the [R languageserver settings](https://github.com/REditorSupport/languageserver#settings) via Zed Project Settings `.zed/settings.json` or Zode User Settings `~/.config/zode/settings.json`:
...
To use the Zode REPL with R you need to install [Ark](https://github.com/posit-dev/ark), an R Kernel for Jupyter applications.
