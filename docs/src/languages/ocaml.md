---
title: OCaml
description: "Configure OCaml language support in Zode, including language servers, formatting, and debugging."
---
...
If you have the development environment already setup, you can skip to [Launching Zode](#launching-zed)
...
With that aside, we can now launch Zode. Given how the OCaml package manager works, we require you to run Zode from the terminal, so please make sure you install the [Zode cli](https://zed.dev/features#cli) if you haven't already.
...
You should now have Zode running with OCaml support, with no additional setup required.
