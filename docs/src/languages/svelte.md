---
title: Svelte
description: "Configure Svelte language support in Zode, including language servers, formatting, and debugging."
---
...
When inlay hints is enabled in Zode, to make the language server send them back, Zode sets the following initialization options:
