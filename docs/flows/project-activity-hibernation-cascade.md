...
spans_entities: ["Worktree", "Terminal", "ProjectPanel", "LanguageServer", "Repository"]
source:
  data-model: ["MODEL003_Project", "MODEL004_Worktree", "MODEL015_ProjectPanel", "MODEL016_Terminal", "MODEL014_Repository", "MODEL017_LanguageServer"]
  features: [F013_WorkspaceAndProjectManagement, F010_Debugging, F009_Diagnostics]
...
outgoing edge drawn in *this* reduced diagram. It is not a stuck state: SM-001's full diagram in
