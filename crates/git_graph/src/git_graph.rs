...
use git::{
    ...
    repository::{CommitDiff, CommitFile, LogOrder, LogSource, RepoPath, SearchCommitArgs},
    status::{FileStatus, StatusCode, TrackedStatus},
};
use git_graph_core::{
    AllCommitCount, GraphData, LANE_WIDTH, LEFT_PADDING, ROW_VERTICAL_PADDING, accent_colors_count,
};
...
use gpui::{
    ...
    ElementId, Empty, Entity, EventEmitter, FocusHandle, Focusable, Pixels, Point, ScrollStrategy,
    ScrollWheelEvent, SharedString, Subscription, Task, TextStyleRefinement,
    UniformListScrollHandle, WeakEntity, Window, actions, anchored, deferred, prelude::*, px,
    uniform_list,
};
...
mod tests {
    ...
    use git_graph_core::{CommitLineSegment, CurveKind};
    use gpui::point;
