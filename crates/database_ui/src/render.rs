                ...
                v_flex()
                    ...
                    .when(self.active.is_some(), |element| {
                        element
                            ...
                            .child(self.render_result_area(window, cx))
                    })
...
impl DatabasePanel {
    ...
    fn render_tree(&self, cx: &mut Context<Self>) -> impl IntoElement {
        ...
        v_flex()
            .when(self.active.is_some(), |element| element.h(self.tree_height))
            .when(self.active.is_none(), |element| element.flex_1())
            .min_h_0()
            .child(
                uniform_list(
                    "database-tree",
    ...
    fn render_result_area(&self, window: &mut Window, cx: &mut Context<Self>) -> impl IntoElement {
        v_flex()
            .flex_1()
            .min_h_0()
            .w_full()
