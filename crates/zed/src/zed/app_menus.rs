    ...
    vec![
        Menu {
            ...
            items: vec![
                ...
                MenuItem::separator(),
                #[cfg(target_os = "macos")]
                MenuItem::action("Hide Zode", super::Hide),
                #[cfg(target_os = "macos")]
                MenuItem::action("Hide Others", super::HideOthers),
                #[cfg(target_os = "macos")]
                MenuItem::action("Show All", super::ShowAll),
                MenuItem::separator(),
                MenuItem::action("Quit Zode", Quit),
            ],
        },
        Menu {
            name: "File".into(),
        ...
        Menu {
            ...
            items: vec![
                ...
                MenuItem::action(
                    "Documentation",
                    super::OpenBrowser {
                        url: "https://github.com/tgiap04/zode/tree/main/docs/src".into(),
                    },
                ),
                MenuItem::action("Zode Repository", feedback::OpenZedRepo),
            ],
        },
    ]
}
